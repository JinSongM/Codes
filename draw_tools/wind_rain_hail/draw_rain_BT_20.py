...
def histogram2d_1(x_data, y_data, x_name, y_name, pic_name):
    ...
    levels = np.arange(1000, np.max(heatmap_array) + int(np.max(heatmap_array)/30), int(np.max(heatmap_array)/30))
...
if __name__=='__main__':
    ...
    filepath = r'/data/PRODUCT/rain_channel/20/merge/merge_rain20.csv'
    data_df = pd.read_csv(filepath)
    data_df = data_df.dropna(axis=0, how='any')
    histogram2d_1(data_df.BT13, data_df.BTD09_13, 'BT13(K)', 'BTD09_13(℃)', '8月份强降水≥20_风云4B卫星通道值分布')
    histogram2d_2(data_df.BT13, data_df.BTD09_10, 'BT13(K)', 'BTD09_10(℃)', '8月份强降水≥20_风云4B卫星通道值分布')
    histogram2d_3(data_df.BT13, data_df.BTD14_13, 'BT13(K)', 'BTD14_13(℃)', '8月份强降水≥20_风云4B卫星通道值分布')
    histogram2d_4(data_df.BTD09_13, data_df.BTD14_13, 'BTD09_13(℃)', 'BTD14_13(℃)', '8月份强降水≥20_风云4B卫星通道值分布')
    histogram2d_5(data_df.BTD09_13, data_df.BTD09_10, 'BTD09_13(℃)', 'BTD09_10(℃)', '8月份强降水≥20_风云4B卫星通道值分布')
    histogram2d_6(data_df.BTD09_10, data_df.BTD14_13, 'BTD09_10(℃)', 'BTD14_13(℃)', '8月份强降水≥20_风云4B卫星通道值分布')