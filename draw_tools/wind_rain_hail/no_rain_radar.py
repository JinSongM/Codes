    ...
    for time_obs in time_list:
        try:
            ...
            if rain_dict is None:
                print('--' * 40)
                continue
            time_utc = time_obs - timedelta(hours=0)
...
if __name__ == '__main__':
    ...
    outfile_m3 = r'/data/PRODUCT/rain_radar_sta/0/{d_time:%Y}/{d_time:%Y%m%d}/{d_time:%Y%m%d%H%M}_{label}.m3'
    outfile_csv = r'/data/PRODUCT/rain_radar_sta/0/{label}.csv'
