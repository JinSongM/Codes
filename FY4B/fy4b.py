...
import numpy as np
from FY4B import utils, components
import xarray as xr
...
class FY4B(CFG):
    ...
    def __init__(self, args: list or str, screen_show_info: bool = True):
        ...
        self.lambda_d = 133.0                   # 卫星星下点所在的经度
    ...
    def read_FY4B(self, file_path: str):
        """
        读取FY4B数据。添加经纬度信息（包括中国区和全圆盘），再转存为nc文件
        Args:
            file_path:  FY4B文件路径
            **kwargs:   读取数据的方法、插值方法
        """
        ...
        if (info['Sensor_Name'] == 'AGRI') and (info['Format'] == 'NC'):
            ...
            return self.read_GIIRS_L2(file_path)
        elif info['Sensor_Name'] == 'LMI':
            return self.read_LMI(file_path)
        else:
            self.raiseE('不支持的输入文件！')

    def read_AGRI_L1_REF(self, file_path: str) -> xr.Dataset:
        # FY4B-_AGRI--_N_DISK_1330E_L1-_FDI-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_0500M_V0001.HDF
        # FY4B-_AGRI--_N_REGC_1330E_L1-_FDI-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_0500M_V0001.HDF
        # FY4B-_AGRI--_N_DISK_1330E_L1-_FDI-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_1000M_V0001.HDF
        # FY4B-_AGRI--_N_REGC_1330E_L1-_FDI-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_1000M_V0001.HDF
        # FY4B-_AGRI--_N_DISK_1330E_L1-_FDI-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_2000M_V0001.HDF
        # FY4B-_AGRI--_N_REGC_1330E_L1-_FDI-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_2000M_V0001.HDF
        # FY4B-_AGRI--_N_DISK_1330E_L1-_FDI-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.HDF
        # FY4B-_AGRI--_N_REGC_1330E_L1-_FDI-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.HDF
    ...
    def read_AGRI_L1_GEO(self, file_path: str) -> xr.Dataset:
        # FY4B-_AGRI--_N_DISK_1330E_L1-_GEO-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.HDF
        # FY4B-_AGRI--_N_REGC_1330E_L1-_GEO-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.HDF
        ds = xr.open_dataset(file_path, engine='netcdf4')
    ...
    def read_AGRI_L2(self, file_path: str) -> xr.Dataset:
        # FY4B-_AGRI--_N_DISK_1330E_L2-_ACI-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_1000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_AMV-_C009_NUL_yyyymmddHHMMSS_yyyymmddHHMMSS_064KM_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_AMV-_C010_NUL_yyyymmddHHMMSS_yyyymmddHHMMSS_064KM_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_AMV-_C012_NUL_yyyymmddHHMMSS_yyyymmddHHMMSS_064KM_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_CFR-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_CIX-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_CLM-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_CLP-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_CLT-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_CTH-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_CTP-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_CTT-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_DLR-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_DSD-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_FHS-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_2000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_FOG-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_LPW-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_LSE-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_012KM_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_LST-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_OLR-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_QPE-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_RSR-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_SSI-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_SST-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_TBB-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_TFP-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_DISK_1330E_L2-_ULR-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_NHEM_1330E_L2-_CFR-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_REGC_1330E_L2-_ACI-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_1000M_V0001.NC
        # FY4B-_AGRI--_N_REGC_1330E_L2-_CIX-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_REGC_1330E_L2-_CLM-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_REGC_1330E_L2-_CLP-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_REGC_1330E_L2-_CLT-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_REGC_1330E_L2-_CTH-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_REGC_1330E_L2-_CTP-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_REGC_1330E_L2-_CTT-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_REGC_1330E_L2-_DSD-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_REGC_1330E_L2-_FHS-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_2000M_V0001.NC
        # FY4B-_AGRI--_N_REGC_1330E_L2-_LPW-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_REGC_1330E_L2-_QPE-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_REGC_1330E_L2-_TBB-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
        # FY4B-_AGRI--_N_REGC_1330E_L2-_TFP-_MULT_NOM_yyyymmddHHMMSS_yyyymmddHHMMSS_4000M_V0001.NC
    ...
    def read_LMI(self, file_path: str) -> xr.Dataset:
        # FY4B-_LMI---_N_REGX_1330E_L2-_LMIE_SING_NUL_yyyymmddHHMMSS_yyyymmddHHMMSS_7800M_NnnV1.NC
        # FY4B-_LMI---_N_REGX_1330E_L2-_LMIG_SING_NUL_yyyymmddHHMMSS_yyyymmddHHMMSS_7800M_NnnV1.NC
        ds = xr.open_dataset(file_path)
        ds = utils.rename_ds(ds, 'LAT', 'lat')
        ds = utils.rename_ds(ds, 'LON', 'lon')
        return ds

    def read_GIIRS_L1(self, file_path: str) -> xr.Dataset:
        # FY4B-_GIIRS-_N_REGX_1330E_L1-_IRD-_MULT_NUL_yyyymmddHHMMSS_yyyymmddHHMMSS_012KM_nnnVm.HDF
        if 'HDF' in file_path:
            return xr.open_dataset(file_path, engine='netcdf4')
        if 'NC' in file_path:
            return xr.open_dataset(file_path)

    def read_GIIRS_L2(self, file_path: str) -> xr.Dataset:
        # FY4B-_GIIRS-_N_REGX_1330E_L2-_AVP-_MULT_NUL_yyyymmddHHMMSS_yyyymmddHHMMSS_012KM_nnnVm.NC
        # FY4B-_GIIRS-_N_REGX_1330E_L2-_AVP-_MULT_NUL_yyyymmddHHMMSS_yyyymmddHHMMSS_012KM_V0002.NC
        if 'HDF' in file_path:
            return xr.open_dataset(file_path, engine='netcdf4')
        if 'NC' in file_path:
            ds = xr.open_dataset(file_path)
...
if __name__ == '__main__':
    ...
    fy4b = FY4B(arg_parsed)

    # FY4B文件路径(任写一种产品即可)
    file_path = r"FY4B-_AGRI--_N_DISK_1330E_L2-_CTT-_MULT_NOM_20230417001500_20230417002959_4000M_V0001.NC"
    # 存储nc的路径
    sv_path = r"D:\data\fy4\1.nc"
    # 需要插值的经纬度
    # new_lon, new_lat = utils.gen_lat_lon(0, 360, 90, -90, 0.05)
    # 得到数据块，并存储为nc
    # fy4b.get_data_from_data_name(file_path, 'AT_Prof_1000', new_lon, new_lat, sv_path=sv_path)
    # 数据对象
    ds = fy4b.read_AGRI_L2(file_path)
    # print(ds)
    logging.debug(ds['Longitude'].values)
