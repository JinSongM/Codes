...
def histogram2d_1(x_data, y_data, x2_data, y2_data, x3_data, y3_data, x_name, y_name, pic_name):
    ...
    levels = np.arange(100, np.max(heatmap_array) + 1, int(np.max(heatmap_array)/6))
    ...
    levels2 = np.arange(10, np.max(heatmap_array2) + 1, int(np.max(heatmap_array2)/6))
    ...
    levels3 = np.arange(1, np.max(heatmap_array3) + 1, int(np.max(heatmap_array3)/6))
...
if __name__=='__main__':
    # mergeCSV(r'/data/PRODUCT/rain_channel/20', r'/data/PRODUCT/rain_channel/20/merge/merge_rain20.csv')
    filepath_rain20 = r'/data/PRODUCT/rain_channel_sta/20/merge/merge_rain20.csv'
    filepath_rain50 = r'/data/PRODUCT/rain_channel_sta/50/merge/merge_rain50.csv'
    filepath_rain80 = r'/data/PRODUCT/rain_channel_sta/80/merge/merge_rain80.csv'
