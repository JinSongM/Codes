...
def histogram2d_1(x_data, y_data, x2_data, y2_data, x3_data, y3_data, x_name, y_name, pic_name):
    ...
    # levels = np.arange(11000, np.max(heatmap_array) + 1, 600)
    levels = np.arange(12000, np.max(heatmap_array) + 1, 1000)
    ...
    # levels2 = np.arange(400, np.max(heatmap_array2) + 1, 60)
    levels2 = np.arange(700, np.max(heatmap_array2) + 1, 20)
    x2, y2 = np.meshgrid(xedges2[:-1], yedges2[:-1])
    # heatmap_array2 = cv2.GaussianBlur(heatmap_array2, (3, 3), 0, 0)
    heatmap_array2 = cv2.GaussianBlur(heatmap_array2, (5, 5), 0, 0)
    ...
    # levels3 = np.arange(24, np.max(heatmap_array3) + 1, 2)
    levels3 = np.arange(100, np.max(heatmap_array3) + 1, 10)
    x3, y3 = np.meshgrid(xedges3[:-1], yedges3[:-1])
    heatmap_array3 = cv2.GaussianBlur(heatmap_array3, (3, 3), 0, 0)
    heatmap3 = ax.contour(x3, y3, heatmap_array3, levels=np.array(levels3), colors='b', linewidths=2)
    if True:
        plt.clabel(heatmap3, inline=1, fontsize=20, fmt='%.0f', colors='b')
    ...
    labels = ['强降水20-50mm', '强降水50-80mm', '强降水≥80mm']
...
def histogram2d_2(x_data, y_data, x2_data, y2_data, x3_data, y3_data, x_name, y_name, pic_name):
    ...
    levels = np.arange(8000, np.max(heatmap_array) + 1, 3000)
    x, y = np.meshgrid(xedges[:-1], yedges[:-1])
    ...
    levels2 = np.arange(500, np.max(heatmap_array2) + 1, 300)
    x2, y2 = np.meshgrid(xedges2[:-1], yedges2[:-1])
    heatmap_array2 = cv2.GaussianBlur(heatmap_array2, (3, 3), 0, 0)
    heatmap2 = ax.contour(x2, y2, heatmap_array2, levels=np.array(levels2), colors='r', linewidths=2)
    if True:
    ...
    levels3 = np.arange(80, np.max(heatmap_array3) + 1, 30)
    x3, y3 = np.meshgrid(xedges3[:-1], yedges3[:-1])
    heatmap_array3 = cv2.GaussianBlur(heatmap_array3, (3, 3), 0, 0)
    heatmap3 = ax.contour(x3, y3, heatmap_array3, levels=np.array(levels3), colors='b', linewidths=2)
    if True:
...
def histogram2d_3(x_data, y_data, x2_data, y2_data, x3_data, y3_data, x_name, y_name, pic_name):
    ...
    levels2 = np.arange(600, np.max(heatmap_array2) + 1, 100)
    x2, y2 = np.meshgrid(xedges2[:-1], yedges2[:-1])
    heatmap_array2 = cv2.GaussianBlur(heatmap_array2, (3, 3), 0, 0)
    heatmap2 = ax.contour(x2, y2, heatmap_array2, levels=np.array(levels2), colors='r', linewidths=2)
    if True:
    ...
    levels3 = np.arange(65, np.max(heatmap_array3) + 1, 10)
    x3, y3 = np.meshgrid(xedges3[:-1], yedges3[:-1])
    heatmap_array3 = cv2.GaussianBlur(heatmap_array3, (3, 3), 0, 0)
    heatmap3 = ax.contour(x3, y3, heatmap_array3, levels=np.array(levels3), colors='b', linewidths=2)
    if True:
...
def histogram2d_4(x_data, y_data, x2_data, y2_data, x3_data, y3_data, x_name, y_name, pic_name):
    ...
    levels = np.arange(13000, np.max(heatmap_array) + 1, 1000)
    x, y = np.meshgrid(xedges[:-1], yedges[:-1])
    heatmap_array = cv2.GaussianBlur(heatmap_array, (5, 5), 0, 0)
    heatmap = ax.contour(x, y, heatmap_array, levels=np.array(levels), colors='black', linewidths=2)
    if True:
    ...
    levels3 = np.arange(90, np.max(heatmap_array3) + 1, 10)
    x3, y3 = np.meshgrid(xedges3[:-1], yedges3[:-1])
    heatmap_array3 = cv2.GaussianBlur(heatmap_array3, (3, 3), 0, 0)
    heatmap3 = ax.contour(x3, y3, heatmap_array3, levels=np.array(levels3), colors='b', linewidths=2)
    if True:
...
def histogram2d_5(x_data, y_data, x2_data, y2_data, x3_data, y3_data, x_name, y_name, pic_name):
    ...
    levels2 = np.arange(800, np.max(heatmap_array2) + 1, 200)
    x2, y2 = np.meshgrid(xedges2[:-1], yedges2[:-1])
    heatmap_array2 = cv2.GaussianBlur(heatmap_array2, (3, 3), 0, 0)
    heatmap2 = ax.contour(x2, y2, heatmap_array2, levels=np.array(levels2), colors='r', linewidths=2)
    if True:
    ...
    levels3 = np.arange(100, np.max(heatmap_array3) + 1, 20)
    x3, y3 = np.meshgrid(xedges3[:-1], yedges3[:-1])
    heatmap_array3 = cv2.GaussianBlur(heatmap_array3, (3, 3), 0, 0)
    heatmap3 = ax.contour(x3, y3, heatmap_array3, levels=np.array(levels3), colors='b', linewidths=2)
    if True:
...
def histogram2d_6(x_data, y_data, x2_data, y2_data, x3_data, y3_data, x_name, y_name, pic_name):
    ...
    levels = np.arange(15000, np.max(heatmap_array) + 1, 2000)
    x, y = np.meshgrid(xedges[:-1], yedges[:-1])
    heatmap_array = cv2.GaussianBlur(heatmap_array, (5, 5), 0, 0)
    heatmap = ax.contour(x, y, heatmap_array, levels=np.array(levels), colors='black', linewidths=2)
    if True:
    ...
    levels3 = np.arange(70, np.max(heatmap_array3) + 1, 20)
    x3, y3 = np.meshgrid(xedges3[:-1], yedges3[:-1])
    heatmap_array3 = cv2.GaussianBlur(heatmap_array3, (3, 3), 0, 0)
    heatmap3 = ax.contour(x3, y3, heatmap_array3, levels=np.array(levels3), colors='b', linewidths=2)
    if True:
...
if __name__=='__main__':
    # mergeCSV(r'/data/PRODUCT/rain_channel_sta/50/month1', r'/data/PRODUCT/rain_channel_sta/50/merge/merge_rain50.csv')
    filepath_rain20 = r'/data/PRODUCT/rain_channel_sta/20/merge3/merge_rain20.csv'
    filepath_rain50 = r'/data/PRODUCT/rain_channel_sta/50/merge3/merge_rain50.csv'
    filepath_rain80 = r'/data/PRODUCT/rain_channel_sta/80/merge3/merge_rain80.csv'
    rain_df = pd.read_csv(filepath_rain20)
    wind_df = pd.read_csv(filepath_rain50)
    hail_df = pd.read_csv(filepath_rain80)

    rain_df = rain_df.dropna(axis=0, how='any')
    wind_df = wind_df.dropna(axis=0, how='any')
    hail_df = hail_df.dropna(axis=0, how='any')
    title_name = '短时强降水-FY4B卫星通道二维频次分布图'
    histogram2d_1(rain_df.BT13, rain_df.BTD09_13, wind_df.BT13, wind_df.BTD09_13, hail_df.BT13, hail_df.BTD09_13, 'BT13(K)', 'BTD09_13(℃)', title_name)
    histogram2d_2(rain_df.BT13, rain_df.BTD09_10, wind_df.BT13, wind_df.BTD09_10, hail_df.BT13, hail_df.BTD09_10, 'BT13(K)', 'BTD09_10(℃)', title_name)
    histogram2d_3(rain_df.BT13, rain_df.BTD14_13, wind_df.BT13, wind_df.BTD14_13, hail_df.BT13, hail_df.BTD14_13, 'BT13(K)', 'BTD14_13(℃)', title_name)
    histogram2d_4(rain_df.BTD09_13, rain_df.BTD14_13, wind_df.BTD09_13, wind_df.BTD14_13, hail_df.BTD09_13, hail_df.BTD14_13, 'BTD09_13(℃)', 'BTD14_13(℃)', title_name)
    histogram2d_5(rain_df.BTD09_13, rain_df.BTD09_10, wind_df.BTD09_13, wind_df.BTD09_10, hail_df.BTD09_13, hail_df.BTD09_10, 'BTD09_13(℃)', 'BTD09_10(℃)', title_name)
    histogram2d_6(rain_df.BTD09_10, rain_df.BTD14_13, wind_df.BTD09_10, wind_df.BTD14_13, hail_df.BTD09_10, hail_df.BTD14_13, 'BTD09_10(℃)', 'BTD14_13(℃)', title_name)