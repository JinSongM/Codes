...
def histogram2d_1(x_data, y_data, x2_data, y2_data, x3_data, y3_data, x_name, y_name, pic_name):
    ...
    levels = np.arange(550, np.max(heatmap_array) + 1, 50)
    ...
    levels2 = np.arange(45, np.max(heatmap_array2) + 1, 6)
    ...
    levels3 = np.arange(5, np.max(heatmap_array3) + 1, 2)
    ...
    labels = ['大风8-10级', '大风10-12级', '大风≥12级']
...
def histogram2d_2(x_data, y_data, x2_data, y2_data, x3_data, y3_data, x_name, y_name, pic_name):
    ...
    levels = np.arange(300, np.max(heatmap_array) + 1, 100)
    x, y = np.meshgrid(xedges[:-1], yedges[:-1])
    heatmap_array = cv2.GaussianBlur(heatmap_array, (5, 5), 0, 0)
    heatmap = ax.contour(x, y, heatmap_array, levels=np.array(levels), colors='black', linewidths=2)
    if True:
    ...
    levels2 = np.arange(50, np.max(heatmap_array2) + 1, 5)
    x2, y2 = np.meshgrid(xedges2[:-1], yedges2[:-1])
    heatmap_array2 = cv2.GaussianBlur(heatmap_array2, (3, 3), 0, 0)
    heatmap2 = ax.contour(x2, y2, heatmap_array2, levels=np.array(levels2), colors='r', linewidths=2)
    if True:
    ...
    levels3 = np.arange(5, np.max(heatmap_array3) + 1, 1)
    x3, y3 = np.meshgrid(xedges3[:-1], yedges3[:-1])
    heatmap_array3 = cv2.GaussianBlur(heatmap_array3, (3, 3), 0, 0)
    heatmap3 = ax.contour(x3, y3, heatmap_array3, levels=np.array(levels3), colors='b', linewidths=2)
    if True:
...
def histogram2d_3(x_data, y_data, x2_data, y2_data, x3_data, y3_data, x_name, y_name, pic_name):
    ...
    levels = np.arange(660, np.max(heatmap_array) + 1, 30)
    x, y = np.meshgrid(xedges[:-1], yedges[:-1])
    heatmap_array = cv2.GaussianBlur(heatmap_array, (5, 5), 0, 0)
    heatmap = ax.contour(x, y, heatmap_array, levels=np.array(levels), colors='black', linewidths=2)
    if True:
    ...
    levels2 = np.arange(35, np.max(heatmap_array2) + 1, 10)
    x2, y2 = np.meshgrid(xedges2[:-1], yedges2[:-1])
    heatmap_array2 = cv2.GaussianBlur(heatmap_array2, (3, 3), 0, 0)
    heatmap2 = ax.contour(x2, y2, heatmap_array2, levels=np.array(levels2), colors='r', linewidths=2)
    if True:
...
def histogram2d_4(x_data, y_data, x2_data, y2_data, x3_data, y3_data, x_name, y_name, pic_name):
    ...
    levels = np.arange(600, np.max(heatmap_array) + 1, 50)
    x, y = np.meshgrid(xedges[:-1], yedges[:-1])
    heatmap_array = cv2.GaussianBlur(heatmap_array, (5, 5), 0, 0)
    heatmap = ax.contour(x, y, heatmap_array, levels=np.array(levels), colors='black', linewidths=2)
    if True:
    ...
    levels2 = np.arange(30, np.max(heatmap_array2) + 1, 5)
    x2, y2 = np.meshgrid(xedges2[:-1], yedges2[:-1])
    ...
    levels3 = np.arange(7, np.max(heatmap_array3) + 1, 2)
    x3, y3 = np.meshgrid(xedges3[:-1], yedges3[:-1])
    heatmap_array3 = cv2.GaussianBlur(heatmap_array3, (3, 3), 0, 0)
    heatmap3 = ax.contour(x3, y3, heatmap_array3, levels=np.array(levels3), colors='b', linewidths=2)
    if True:
...
def histogram2d_5(x_data, y_data, x2_data, y2_data, x3_data, y3_data, x_name, y_name, pic_name):
    ...
    levels = np.arange(500, np.max(heatmap_array) + 1, 100)
    x, y = np.meshgrid(xedges[:-1], yedges[:-1])
    heatmap_array = cv2.GaussianBlur(heatmap_array, (5, 5), 0, 0)
    heatmap = ax.contour(x, y, heatmap_array, levels=np.array(levels), colors='black', linewidths=2)
    if True:
    ...
    levels2 = np.arange(45, np.max(heatmap_array2) + 1, 3)
    x2, y2 = np.meshgrid(xedges2[:-1], yedges2[:-1])
    heatmap_array2 = cv2.GaussianBlur(heatmap_array2, (5, 5), 0, 0)
    heatmap2 = ax.contour(x2, y2, heatmap_array2, levels=np.array(levels2), colors='r', linewidths=2)
    if True:
    ...
    levels3 = np.arange(6, np.max(heatmap_array3) + 1, 2)
    x3, y3 = np.meshgrid(xedges3[:-1], yedges3[:-1])
    heatmap_array3 = cv2.GaussianBlur(heatmap_array3, (3, 3), 0, 0)
    heatmap3 = ax.contour(x3, y3, heatmap_array3, levels=np.array(levels3), colors='b', linewidths=2)
    if True:
...
def histogram2d_6(x_data, y_data, x2_data, y2_data, x3_data, y3_data, x_name, y_name, pic_name):
    ...
    levels = np.arange(700, np.max(heatmap_array) + 1, 100)
    x, y = np.meshgrid(xedges[:-1], yedges[:-1])
    heatmap_array = cv2.GaussianBlur(heatmap_array, (5, 5), 0, 0)
    heatmap = ax.contour(x, y, heatmap_array, levels=np.array(levels), colors='black', linewidths=2)
    if True:
    ...
    levels3 = np.arange(4, np.max(heatmap_array3) + 1, 2)
    x3, y3 = np.meshgrid(xedges3[:-1], yedges3[:-1])
    heatmap_array3 = cv2.GaussianBlur(heatmap_array3, (3, 3), 0, 0)
    heatmap3 = ax.contour(x3, y3, heatmap_array3, levels=np.array(levels3), colors='b', linewidths=2)
    if True:
...
if __name__=='__main__':
    # mergeCSV(r'/data/PRODUCT/wind_channel_sta/8', r'/data/PRODUCT/wind_channel_sta/8/merge/merge_wind8.csv')
    filepath_rain20 = r'/data/PRODUCT/wind_channel_sta/8/merge/merge_wind8.csv'
    filepath_rain50 = r'/data/PRODUCT/wind_channel_sta/10/merge/merge_wind10.csv'
    filepath_rain80 = r'/data/PRODUCT/wind_channel_sta/12/merge/merge_wind12.csv'
    ...
    title_name = '雷暴大风-FY4B卫星通道二维频次分布图'
