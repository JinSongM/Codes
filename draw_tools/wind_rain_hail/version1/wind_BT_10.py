...
if __name__ == '__main__':
    ...
    outfile_m3 = r'/data/PRODUCT/wind_channel_sta/10/{d_time:%Y}/{d_time:%Y%m%d}/{d_time:%Y%m%d%H%M}_{label}.m3'
    outfile_csv = r'/data/PRODUCT/wind_channel_sta/10/{label}.csv'
