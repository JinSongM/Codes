...
def histogram2d_1(x_data, y_data, x_name, y_name, pic_name):
    ...
    levels = np.arange(0, np.max(heatmap_array)-2, 1)
...
def histogram2d_3(x_data, y_data, x_name, y_name, pic_name):
    ...
    extent = [xedges[0], xedges[-1], yedges[0], yedges[-1]]
    levels = np.arange(0, np.max(heatmap_array) - 3, 1)
    cmap, norm = cm_collected.get_cmap('ncl/CBR_wet', extend='max', levels=levels)
    heatmap_array = cv2.blur(heatmap_array.T, (3, 3))
    heatmap = plt.imshow(heatmap_array, extent=extent, origin='lower', cmap=cmap, norm=norm)
    l, b, w, h = ax.get_position().bounds
...
if __name__=='__main__':
    ...
    title = '6-8月份冰雹_风云4B卫星通道值分布'
    histogram2d_1(hail_df.BT13, hail_df.BTD09_13, 'BT13(K)', 'BTD09_13(℃)', title)
    histogram2d_2(hail_df.BT13, hail_df.BTD09_10, 'BT13(K)', 'BTD09_10(℃)', title)
    histogram2d_3(hail_df.BT13, hail_df.BTD14_13, 'BT13(K)', 'BTD14_13(℃)', title)
    histogram2d_4(hail_df.BTD09_13, hail_df.BTD14_13, 'BTD09_13(℃)', 'BTD14_13(℃)', title)
    histogram2d_5(hail_df.BTD09_13, hail_df.BTD09_10, 'BTD09_13(℃)', 'BTD09_10(℃)', title)
    histogram2d_6(hail_df.BTD09_10, hail_df.BTD14_13, 'BTD09_10(℃)', 'BTD14_13(℃)', title)