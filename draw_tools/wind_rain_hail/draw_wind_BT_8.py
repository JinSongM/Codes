...
if __name__=='__main__':
    # mergeCSV(r'/data/PRODUCT/wind_channel_sta/8', r'/data/PRODUCT/wind_channel/8/merge/merge_wind8.csv')
    filepath = r'/data/PRODUCT/wind_channel_sta/8/merge/merge_wind8.csv'
