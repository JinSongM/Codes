...
c3e_Ppt1 = r'/share/DATASOURCE/PTYPE/CVT/FST/C3E/{rp_T:%Y%m%d}/ptype/{rp_T:%Y%m%d%H}_{cst:03d}.csv'
c1d_Ppt2 = r'/share/DATASOURCE/PTYPE/CVT/FST/C1D/{rp_T:%Y%m%d}/ptype/{rp_T:%Y%m%d%H}_{cst:03d}.csv'
c3e_pt1 = r'/share/DATASOURCE/PTYPE/CVT/FST/C3E/{rp_T:%Y%m%d}/ptype/{rp_T:%Y%m%d%H}_{cst:03d}.nc'
c1d_pt2 = r'/share/DATASOURCE/PTYPE/CVT/FST/C1D/{rp_T:%Y%m%d}/ptype/{rp_T:%Y%m%d%H}_{cst:03d}.nc'
c1d_Ppt2_sta = r'/share/DATASOURCE/PTYPE/CVT/FST/C1D/ptype/{rp_T:%Y%m%d}/{rp_T:%Y%m%d%H}_{cst:03d}.m3'
...
NAFP_png = r'/share/DATASOURCE/PTYPE/IMAGES/{rp_T:%Y%m%d}/{model}_{rp_T:%Y%m%d%H}_{cst:03d}_{model_type}.png'
