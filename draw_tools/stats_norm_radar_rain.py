...
class loadData:
    ...
    def __init__(self):
        # 雷达数据
        self.rain0_file = r'/data/PRODUCT/rain_radar_sta/0/radar.csv'
        self.rain1_file = r'/data/PRODUCT/rain_radar_sta/20/radar.csv'
        self.rain2_file = r'/data/PRODUCT/rain_radar_sta/50/radar.csv'
        self.rain3_file = r'/data/PRODUCT/rain_radar_sta/80/radar.csv'
        ...
        try:
            ...
            self.rain1_df = pd.concat([self.rain_df3], axis=0)
    ...
    def eigenvalue(self, channels):
        ...
        if not os.path.exists(filepath):
            ...
            for channel in channels:
                try:
                    xdata_0 = np.sort(self.rain0_df.get('data0').to_list())
                    mean_0, std_0 = norm.fit(xdata_0)
                    xdata_1 = np.sort(self.rain1_df.get('data0').to_list())
...
class MonitorConvection:
    ...
    def draw_rainlabel(self, LabelGrd, background):
        try:
            ...
            xr_data_array = cv2.blur(xr_data_array, (3, 3))
